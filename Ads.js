...
// Remove the navigation with class 'LIVEVIPheader'
function blockNavByClass(className) {
    var navElement = document.querySelector('.' + className); // Select the nav element
    if (navElement) {
        navElement.remove(); // Remove it from the DOM
    }
}

blockNavByClass('LIVEVIPheader');
